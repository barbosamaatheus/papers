...
class OAConflictReporter:
    PLOT_FILENAME = "oa_conflict_types_pie.png"
    ...
    def write(self, report):
        ...
        output_path = os.path.join(self.output_dir, "oa_conflict_report.json")
    ...
    def plot(self, report):
        ...
        self.visualizer.plot_pie_chart(
            ...
            "Distribution of OA Conflict Types",
            filename,
        )
