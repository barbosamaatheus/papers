...
class CFConflictReporter:
    PLOT_FILENAME = "cf_conflict_types_pie.png"
    ...
    def write(self, report):
        ...
        output_path = os.path.join(self.output_dir, "cf_conflict_report.json")
    ...
    def plot(self, report):
        ...
        self.visualizer.plot_pie_chart(
            ...
            "Distribution of CF Conflict Types",
            filename,
        )
